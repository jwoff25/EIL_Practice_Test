...
var collocation = [];
for (var x = 1; x < 241; x++){
    collocation.push("col " + x.toString());
}
...
function renderQuestion(){
    ...
    //print them out baby
    test.innerHTML = "<br>" + answer_box + " " + a1 + "<br><br>";
	test.innerHTML += answer_box + " " + a2 + "<br><br>";
    test.innerHTML += answer_box + " " + a3 + "<br><br>";
    test.innerHTML += answer_box + " " + a4 + "<br><br>";
    test.innerHTML += answer_box + " " + a5 + "<br><br>";
	test.innerHTML += answer_box + " " + a6 + "<br><br>";
